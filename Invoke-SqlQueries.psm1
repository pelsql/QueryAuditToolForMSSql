...
#>
    ...
    if ($user -ne '')
    {
        $SqlCon = new-object System.Data.SqlClient.SQLConnection("Data Source=tcp:$serverInstance;User=$User;Password=$pwd;Initial Catalog=$database;App=Invoke-SqlQueries");
    }
    else
    {
        $SqlCon = new-object System.Data.SqlClient.SQLConnection("Data Source=tcp:$serverInstance;Trusted_Connection=True;Initial Catalog=$database;App=Invoke-SqlQueries;WSID=Contournement");
    }
